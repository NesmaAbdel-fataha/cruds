...
submit.onclick =()=>{                      // create button 
    ...
    if(title.value!='' && price.value!='' && category.value!=''){
          ...
          if(mode==="create"){
                        ...
                        }else if(newProduct.count==1 || newProduct.count==''){    
                            dataProduct.push(newProduct);
                        }           
...
function nightMode(){
    ...
    for(let i=0;i<button.length;i++){
        button[i].style.backgroundColor='#ff0157';
        button[i].style.border='1px solid #ff0157'
...
function lightMode(){
    ...
    for(let i=0;i<button.length;i++){
        ...
        button[i].style.border='2px solid #ff0157'
    }
}
